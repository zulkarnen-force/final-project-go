...
type User struct {
	...
	Username  string    `gorm:"uniqueIndex" json:"username,omitempty" valid:"required~Your Username is required"`
	Email     string    `gorm:"uniqueIndex" json:"email,omitempty" valid:"email,required~Your Email is required"`
